const users = {
    ...
    'c14816ad-efb1-4d45-a04a-05464e812cbb': { username: 'gomes', name: 'Nuno Gomes', club: 'Varzim FC' }
}
...
const credentials = {
    ...
    'gomes': { password: 'gomitas', token: 'c14816ad-efb1-4d45-a04a-05464e812cbb'}
}
...
const groups = {
    ...
    'c14816ad-efb1-4d45-a04a-05464e812cbb': new Map().set(
        0,
        {
            name: 'Happy Games',
            description: 'The happiest games in the planet D:',
            games: new Set().add('RLlDWHh7hR')
        }).set(
            1,
        {
            name: 'Sad Games',
            description: 'The saddest games in the planet ):',
            games: new Set().add('RLlDWHh7hR')
        })
}
